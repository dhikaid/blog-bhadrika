...
<div class="px-10 md:max-w-screen-md mx-auto mt-24 leading-loose">
    <div class="content-detail">
        ...
        <!-- error data -->
        <form action="<?= base_url('blogs/save'); ?>" method="POST" enctype="multipart/form-data">
            <!-- amanin -->
            <?= csrf_field(); ?>
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                <!-- <textarea type="text" id="text" name="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required><?= old('text'); ?> </textarea> -->
                ...
                <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                    ...
                    <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                        ...
                        <textarea id="editor" name="text" rows="8" class="block w-full px-0 text-sm text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write an article..." required><?= old('text'); ?></textarea>
                    </div>
                </div>
